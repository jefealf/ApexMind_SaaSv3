      ...
      <div className="flex items-center gap-5">
        ...
        <div className="flex items-center gap-3 cursor-pointer hover:bg-slate-800/50 p-1.5 pr-3 rounded-lg transition-colors border border-transparent hover:border-slate-800">
          <div className="w-8 h-8 rounded-lg bg-gradient-to-tr from-cyan-600 to-blue-600 p-[1px]">
             <div className="w-full h-full rounded-lg bg-[#0b0f19] flex items-center justify-center overflow-hidden">
                <User size={16} className="text-cyan-400" /> 
             </div>
          </div>
          <div className="text-left hidden md:block">
            <p className="text-xs font-bold text-white leading-none mb-0.5">Jefe</p>
            <p className="text-[9px] text-cyan-400 font-mono bg-cyan-900/20 px-1 rounded uppercase tracking-wider">Pro</p>
          </div>
        </div>
      </div>
    </header>
